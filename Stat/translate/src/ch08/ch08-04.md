...
(`standard unit` đã được thảo luận ở Mục 5.1) Quy trình này có thể được đưa ra dưới dạng công thức, trong đó x là biến đầu tiên, y là biến thứ hai và r là `correlation coefficient`:
